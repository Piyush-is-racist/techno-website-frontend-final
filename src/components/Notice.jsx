...
const API = "https://techno-backend-76p3.onrender.com/api/notices";
...
const Notice = () => {
  ...
  const deleteSelected = async () => {
    if (selected.length === 0) return alert("No notices selected.");
    const confirm = window.confirm("Delete selected notices?");
    if (!confirm) return;
  ...
  return (
    <div className="p-6">
      <h2 className="text-2xl font-bold text-red-800 mb-4">📝 Create Notice</h2>
      <form
      ...
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-xl font-semibold text-red-800">📢 All Notices</h3>
        <button
